...
public class AlertWindowController {
    ...
    public void withOpenFile(Stage stage, PayFileClient.File file, File destination, int secondsTaken) {
        messageLabel.setText("Download complete");
        detailsLabel.setText(String.format("'%s' was successfully downloaded in %d seconds.", file.getFileName(), secondsTaken));
        cancelButton.setVisible(false);
